...
namespace Mc2.CrudTest.Presentation.Server.Models
{
    public partial class ApiResponse
    {
        ...
        public static ApiResponse Ok() =>
            new ApiResponse() { Success = true, StatusCode = StatusCodes.Status200OK };

        public static ApiResponse Ok(string successMessage) =>
            new ApiResponse() { Success = true, StatusCode = StatusCodes.Status200OK, SuccessMessage = successMessage };

        public static ApiResponse BadRequest() =>
            new ApiResponse() { Success = false, StatusCode = StatusCodes.Status400BadRequest };
